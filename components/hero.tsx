    ...
    <section className="relative min-h-[600px] md:min-h-[700px] flex items-center justify-center overflow-hidden bg-gradient-to-b from-muted/30 to-background">
      ...
      <div className="container relative z-10 mx-auto px-4 py-16 md:py-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-[2.0rem] md:text-[3.0rem] lg:text-[3.5rem] font-bold tracking-tight mb-6 text-balance">
            Transform Your Space Without the Remodel Price
          </h1>

          <p className="text-base md:text-lg text-muted-foreground mb-8 text-balance leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button asChild size="lg" className="text-sm px-8">
              <Link href="#contact">
                Free Consultation <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="text-sm px-8 bg-transparent">
